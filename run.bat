...
if not exist "d:/GitHub/bouncing_balls/build" (
    mkdir "d:/GitHub/bouncing_balls/build"
)

rem Run CMake to generate the makefiles
cmake -G "MinGW Makefiles" -DCMAKE_BUILD_TYPE=Debug -DCMAKE_EXPORT_COMPILE_COMMANDS=TRUE --no-warn-unused-cli -S D:/GitHub/bouncing_balls -B d:/GitHub/bouncing_balls/build

rem Move to the build directory
cd d:/GitHub/bouncing_balls/build
